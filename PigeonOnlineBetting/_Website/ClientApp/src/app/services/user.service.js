...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getMemberDistance = function (clubname, memberidno, dbname) {
        var getURL = this._baseUrl + 'api/member/GetMemberDistance?clubname=' + clubname + '&memberidno=' + memberidno + '&dbname=' + dbname;
        return this.http.get(getURL);
    };
    UserService.prototype.getLogs = function (formData) {
        var getURL = this._baseUrl + 'api/member/GetViewLogs';
        return this.http.post(getURL, formData);
    };
