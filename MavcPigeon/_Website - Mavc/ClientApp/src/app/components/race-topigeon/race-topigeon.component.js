...
var RaceResultComponent = /** @class */ (function () {
    function RaceResultComponent(fb, 
    //private route: ActivatedRoute,
    //private router: Router,
    authenticationService, alertService, raceService, 
    ...
    RaceResultComponent.prototype.GetRaceDetails = function () {
        ...
        this.raceService.getRaceDetails(this.form.value).subscribe(function (data) {
            ...
            if (_this.raceDetails[0]) {
                ...
                if (_this.raceDetails[0].StopTime != "") {
                    _this.StopTimeFrom = _this.raceDetails[0].StopFrom;
                    _this.StopTimeTo = _this.raceDetails[0].StopTo;
                    _this.IsTimeStop = true;
                }
            }
            else {
                _this.LocationName = "";
