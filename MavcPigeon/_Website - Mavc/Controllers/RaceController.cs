...
namespace _Website.Controllers
{
    ...
    public class RaceController : Controller
    {
        ...
        public async Task<IActionResult> GetLocation([FromBody] RaceFilter raceFilter)
        {
            try
            {
                return Ok(this.Content(JsonConvert.SerializeObject(await _race.GetLocation(raceFilter)), "application/json"));
            }
            catch (Exception ex)
            {
                //ExceptionLog exception = await _exceptionService.UpsertException(ex, "GetUserRoles", "","");
        ...
        [HttpGet("[action]")]
        [AllowAnonymous]
        public async Task<IActionResult> QRCodeClocking([FromQuery] string qrcode)
        {
            try
            {
                return Ok(this.Content(JsonConvert.SerializeObject(await _race.QRCodeClocking(qrcode)), "application/json"));
            }
            catch (Exception ex)
            {
                //ExceptionLog exception = await _exceptionService.UpsertException(ex, "GetUserRoles", "","");
