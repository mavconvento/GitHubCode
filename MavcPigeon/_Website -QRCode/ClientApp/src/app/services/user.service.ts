...
export class UserService {
  ...
  getMemberDistance(clubname: string, memberidno: string, dbname: string) {
    let getURL = this._baseUrl + 'api/member/GetMemberDistance?clubname=' + clubname + '&memberidno=' + memberidno + '&dbname=' + dbname;
    return this.http.get<any>(getURL);
  }

  getLogs(formData: FormData): Observable<any> {
    let getURL = this._baseUrl + 'api/member/GetViewLogs';
