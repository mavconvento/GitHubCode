...
namespace Integrate_Data
{
    ...
    {
        const string import_Get = "Import_LocationGet";
        const string import_Process = "Import_LocationProcess";
        Integrate_Data.DatabaseConnection dbconn;

        public void LocationImport(string primaryID, string clubID, string action, string fileNotesID)
        {
            try
            {
                switch (action)
