...
namespace Integrate_Data
{
    ...
    {
        const string import_Get = "Import_RaceScheduleGet";
        const string import_Process = "Import_RaceScheduleProcess";
        Integrate_Data.DatabaseConnection dbconn;

        public void RaceScheduleImport(string primaryID, string clubID, string action, string fileNotesID)
        {
            try
            {
                switch (action)
