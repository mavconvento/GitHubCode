<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RaceResult_V1.ascx.cs"
    Inherits="MAVCPigeonClockingWebsite.RaceResult_V1" %>
    ...
    <table class="HTMLTable">
        <tr>
            <td colspan="4" class="TD_Heading">
                <asp:Label ID="Label1" runat="server"><b>Race Results (V1):</b></asp:Label>
                <telerik:RadGrid ID="rgResults" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <MasterTableView DataKeyNames="" AllowSorting="True" AllowPaging="True" PageSize="10">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn FilterControlAltText="Filter column column" HeaderText="Sender"
                                UniqueName="Sender" DataField="Sender" HeaderStyle-VerticalAlign="Top" HeaderStyle-HorizontalAlign="Left"
                                ItemStyle-Width="35px" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false"
                                HeaderStyle-Width="35px">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn FilterControlAltText="Filter column column" HeaderText="Member Name"
                                UniqueName="MemberName" DataField="MemberName" HeaderStyle-VerticalAlign="Top" HeaderStyle-HorizontalAlign="Left"
                                ItemStyle-Width="35px" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false"
                                HeaderStyle-Width="35px">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn FilterControlAltText="Filter column column" HeaderText="Sticker Code"
                                UniqueName="StickerCode" DataField="StickerCode" HeaderStyle-VerticalAlign="Top" HeaderStyle-HorizontalAlign="Left"
                                ItemStyle-Width="35px" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false"
                                HeaderStyle-Width="35px">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn FilterControlAltText="Filter column column" HeaderText="Arrival Time"
                                UniqueName="ArrivalTime" DataField="ArrivalTime" HeaderStyle-VerticalAlign="Top" HeaderStyle-HorizontalAlign="Left"
                                ItemStyle-Width="35px" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false"
                                HeaderStyle-Width="35px">
                            </telerik:GridBoundColumn>
                        </Columns>
