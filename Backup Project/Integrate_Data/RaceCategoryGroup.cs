...
{
    public class RaceCategoryGroup
    {
        const string import_Get = "Import_RaceCategoryGroupGet";
        const string import_Process = "Import_RaceCategoryGroupProcess";
        Integrate_Data.DatabaseConnection dbconn;

        public void RaceCategoryGroupImport(string primaryID, string clubID, string action, string fileNotesID)
        {
            try
            {
                switch (action)
