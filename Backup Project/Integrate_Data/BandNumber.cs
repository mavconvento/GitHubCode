...
namespace Integrate_Data
{
    ...
    {
        const string import_Get = "Import_BandNumberGet";
        const string import_Process = "Import_BandNumberProcess";
        Integrate_Data.DatabaseConnection dbconn;

        public void BandNumberImport(string primaryID, string clubID, string action, string fileNotesID)
        {
            try
            {
                switch (action)
